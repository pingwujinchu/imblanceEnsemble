...
public class BaggingOverUnderSimple extends BasicClassification{

	public BaggingOverUnderSimple(Instances data) {
		super(data);
	...
	public List<EvaluationInfo> getClassificationResult(Classifier classifier, String classifier_name, int times,
		...
		result.add(getResult(",bagging over undersimple", classifier_name, validationResult, times,ei));
		return result;
	}
