...
public class BoostingOverOverSimple extends BasicClassification{

	public BoostingOverOverSimple(Instances data) {
		super(data);
	...
	public List<EvaluationInfo> getClassificationResult(Classifier classifier, String classifier_name, int times,
		...
		result.add(getResult("underboost", classifier_name, validationResult, times,ei));
		return result;
	}
